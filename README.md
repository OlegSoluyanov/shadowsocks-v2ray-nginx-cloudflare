...
* Во вкладке Серверы - Редактировать серверы необходимо заполнить:
   * `Server addr` - имя домена example.com
   * `Server port` - 443
   * `Password` - пароль из файла конфигурации shadowsocks-rust.json
